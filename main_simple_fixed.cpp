/*
 * Cybor's Counter Strike v2.5 - Console Version (Fixed)
...
public:
    ...
    void TakeDamage(float damage) {
        if (damage < 0) {
            // Healing
            m_health = std::min(100.0f, m_health - damage);
            std::cout << "Player healed for " << -damage << " health. Health: " << m_health << std::endl;
        } else {
            // Damage
            if (m_armor > 0.0f) {
    ...
    void Heal(float amount) {
        ...
        std::cout << "Player healed for " << amount << " health. Health: " << m_health << std::endl;
    }
...
public:
    ...
    void TakeDamage(float damage) {
        if (damage < 0) {
            // Healing
            m_health = std::min(100.0f, m_health - damage);
            std::cout << m_name << " healed for " << -damage << " health. Health: " << m_health << std::endl;
        } else {
            // Damage
            m_health -= damage;
    ...
    void Heal(float amount) {
        m_health = std::min(100.0f, m_health + amount);
        std::cout << m_name << " healed for " << amount << " health. Health: " << m_health << std::endl;
    }
